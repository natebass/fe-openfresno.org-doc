  ...
  <div className="sb-section">
    ...
    <div className="sb-section-item">
      ...
      <div>
        ...
        <p className="sb-section-item-paragraph">To link static files (like fonts) to your projects and stories, use the `staticDirs` configuration option to specify folders to load when starting Storybook.</p>
        <Link
  ...
  <div className="sb-section">
    <div className="sb-features-grid">
      ...
      <div className="sb-grid-item">
        ...
        <p className="sb-section-item-paragraph">Embed your stories into Figma to cross-reference the design and live implementation in one place.</p>
        <Link
      ...
      <div className="sb-grid-item">
        ...
        <p className="sb-section-item-paragraph">Use stories to test a component in all its variations, no matter how complex.</p>
        <Link
...
<div className="sb-addon">
  <div className="sb-addon-text">
    ...
    <Link
      ...
      target="_blank"
    >Discover all addons<RightArrow /></Link>
  </div>
...
<div className="sb-section sb-socials">
  <div className="sb-section-item">
    ...
    <Link href="https://github.com/storybookjs/storybook" target="_blank">Star on GitHub<RightArrow /></Link>
  </div>
  <div className="sb-section-item">
    <BasePathImage
      width={33}
    ...
    <div>
      ...
      <Link href="https://discord.gg/storybook" target="_blank">Join Discord server<RightArrow /></Link>
    </div>
  </div>
  <div className="sb-section-item">
    <BasePathImage
    ...
    <div>
      ...
      <Link href="https://www.youtube.com/@chromaticui" target="_blank">Watch on YouTube<RightArrow /></Link>
    </div>
  </div>
  <div className="sb-section-item">
    <BasePathImage
    ...
    <Link
      ...
      target="_blank"
    >Discover tutorials<RightArrow /></Link>
  </div>
</div>
