import GeneralSectionStories from "./GeneralSection.stories";
import { Meta } from "@storybook/addon-docs/blocks";

<Meta of={GeneralSectionStories} />
...
- subHeading \{JSX.Element\} - The sub heading to display. Can be a string or a react element.
