  ...
  return (
    <div className="home-numbered-grid">
      <div className="home-numbered-container">
        ...
        <h2 className="home-numbered-header sm:h3-bold h4-bold">Engage with Our Community</h2>
        <p className="home-numbered-paragraph p3-regular">
          ...
          meetups. Join us to be a part of a vibrant community dedicated to positive change through
          technology.
        </p>
        <Button
          className="btn"
      ...
      <div className="home-numbered-container">
        ...
        <h2 className="home-numbered-header sm:h3-bold h4-bold">Drive Innovation with Projects</h2>
        <p className="home-numbered-paragraph p3-regular">
        ...
        <Button className="btn" href="/projects" textContent="See Our Projects" />
      </div>
      <div className="home-numbered-container">
        <Image src="/img/3.png" alt="Open Data Day" width={81} height={80} />
        <h2 className="home-numbered-header sm:h3-bold h4-bold">Pitch Your Vision</h2>
        <p className="home-numbered-paragraph p3-regular">
