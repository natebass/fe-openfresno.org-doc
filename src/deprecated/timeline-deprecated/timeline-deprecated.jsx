...
/**
 * A responsive, multistep timeline component for displaying a list of opportunities.
 *
    ...
    <div className={`timeline ${className}`}>
      ...
      <div className="timeline-item">
        ...
        <div className="timeline-item-content">
          ...
          <p>
            ...
            meetups.
            <br />
            Join us to be a part of a vibrant community dedicated to positive change through
            technology.
          </p>
          <Button
      ...
      <div className="timeline-item">
        ...
        <div className="timeline-item-content">
          ...
          <p>
            Have a project idea that can benefit the community? Pitch it to us and join forces with
            our community of innovators to bring your vision to life, driving positive change in
            Central California.
          </p>
          <Button className="btn btn--grow mx-auto mt-2 lg:mx-0" href="">
            Pitch a Project
      ...
      <div className="timeline-item">
        ...
        <div className="timeline-item-content">
          <h2 className="heading-small">Explore On-Site Opportunities with Root Access</h2>
          <p>
            Discover Root Access on Van Ness Ave in the Tower District, just a block south of Fresno
            City College. From advanced 3D printers and a cozy lounge to laser cutting, workshops,
            and an electronics haven, <b>explore what awaits you at our partner&apos;s space!</b>
          </p>
